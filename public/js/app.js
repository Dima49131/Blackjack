...
let bankValue = parseFloat(localStorage.getItem("balanceupdate"));
let currentBet = 0;
let wager = 5;
let lastWager = 0;
let bet = [];
...
function spin(){
	...
	localStorage.setItem("balanceupdate",bankValue)
	tokenbalance.innerHTML = bankValue.toFixed(2)+ " Tokens"
